...
export default function CGU() {
  return (
    <LegalShell eyebrow="Conditions d'utilisation" title="Conditions Générales d'Utilisation" updated="Version 1.0 — Dernière mise à jour : juillet 2026">
      <section>
        <h2>Article 1 — Objet</h2>
        <p>Les présentes Conditions Générales d'Utilisation (CGU) régissent l'accès et l'utilisation de l'application SaaS Skalcook, éditée par <strong>AD Consulting</strong>, entreprise individuelle (micro-entrepreneur) dont les coordonnées figurent dans les <a href="/mentions-legales">mentions légales</a>. En accédant à l'application, l'utilisateur accepte sans réserve les présentes CGU.</p>
      </section>
      ...
      <section>
        <h2>Article 4 — Abonnement et facturation</h2>
      ...
      <section>
        <h2>Article 7 — Données et confidentialité</h2>
      ...
      <div className="sk-legal__callout">
        <strong>Contact :</strong> Pour toute question relative aux présentes CGU, contactez-nous à <a href="mailto:contact@skalcook.fr">contact@skalcook.fr</a>
      </div>
    </LegalShell>
  )
}
